...
const HeroSection = () => {
  ...
  return (
    <>
      ...
      <section id="hero" className="relative bg-gradient-to-r from-[#a72c1a] via-[#d35400] to-[#e67e22] text-white overflow-hidden px-4" style={{ paddingTop: '12vh', paddingBottom: '12vh' }}>
